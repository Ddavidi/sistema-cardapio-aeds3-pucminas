...
2.  **Abra o projeto no IntelliJ IDEA:**
    * No IntelliJ, vá em `File` > `Open...`.
    * Navegue até à pasta onde clonou o repositório e selecione-a.
    * Aguarde o IntelliJ carregar o projeto e sincronizar as dependências do Maven (se houver).

3.  **Execute a aplicação:**
    * Navegue na árvore de ficheiros do projeto até `src/main/java/app/Main.java`.
    * Abra o ficheiro `Main.java`.
    * Clique com o botão direito do rato dentro do editor de código e selecione a opção **`Run 'Main.main()'`**.

4.  **Interaja com o Console:**
    * O menu interativo será exibido no painel "Run" na parte inferior do IntelliJ.
    * Siga as instruções do menu para criar, listar, atualizar e excluir os dados.
    * Os ficheiros da base de dados (`.db`, `.hash.*`, `.bptree.idx`) serão criados automaticamente na pasta raiz do projeto.